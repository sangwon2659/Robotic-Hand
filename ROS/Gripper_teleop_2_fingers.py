...
def callback(jointpos):
    global iteration, num_iteration
    sum_angle_1 = 0
    sum_angle_2 = 0

    while iteration < num_iteration:
	sum_angle_1 += jointpos.jointpos1
        sum_angle_2 += jointpos.jointpos2
	iteration += 1
    ...
    angle_1_goal = jointpos.jointpos1 - angle_1_offset
    angle_2_goal = jointpos.jointpos2 - angle_2_offset

    angle_1_goal, angle_2_goal = dis2inc(angle_1_goal, angle_2_goal)
...
def gripper():
    ...
    while 1:
    	rospy.Subscriber('jointpos', angle_finger2, callback)
    	rospy.spin()
